...
% prob.par2prob       = @par2NForm;
par                 =  [-1, 0.2, -1, 2.5, 0.5, 0.875926384431162, 0, 0];
keys                = {'lambda_1', 'lambda_2', 'lambda_3','b2','b3','T', 'mu','eta'};
prob.par2prob       = @par2NForm_full;
...
bd1 = coco(prob1, '3D_case_eta_T', [], 1, {'eta','T'},  {p_span,X_span});
% 
...
haxes2 = axes;
thm = struct('special', {{'BP','FP'}});
coco_plot_bd(thm, '3D_case_eta_T', 'eta', 'T')
hold on
