...
L_mu    = -0.005;
FIG2 = figure;
h1 = plot(S_mu_list,S_mu_list.*S_v_pre,'r-','LineWidth',2,'displayname','Stable LCO');
hold on

% Color region  to zoom in
box1_x = [SN_mu SN_mu R_mu R_mu SN_mu];
box1_y = [-2.5 0.2 0.2 -2.5 -2.5 ]*1e-3;
V = [box1_x(1), box1_y(1);
    box1_x(2), box1_y(2);
    box1_x(3), box1_y(3);
    box1_x(4), box1_y(4)];
...
box2_y = [-2.5 0.2 0.2 -2.5 -2.5 ]*1e-3;
...
%
h2 = plot(S_mu_list,S_mu_list.*S_v,'k-','LineWidth',2,'displayname','Stable LCO');
h3 = plot(US_mu_list,US_mu_list.*US_v_pre,'r--','LineWidth',2,'displayname','Stable LCO');
h4 = plot(US_mu_list,US_mu_list.*US_v,'k--','LineWidth',2,'displayname','Stable LCO');
h5 = plot(mu_crit, mu_crit.*US_v(end), 'rd','MarkerSize',6,'MarkerFaceColor',[1 1 1],'linewidth',1.5,'displayname','SN');
