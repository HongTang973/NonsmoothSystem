...
data(data<=1e-5) = NaN;
mu_list          = A_diagram(:,1)+0.0264121728473816;
...
plot(S_u(7,end),S_br(end),'rd','markersize',4,'markerfacecolor',[1 1 1],'linewidth',2)
...
h4 = plot(mu_list(335),data(335,1),'rd','markersize',4,'markerfacecolor',[1 1 1],'linewidth',2,'DisplayName','SN point');
...
%% post processing
name ='.\3D_BEB_SN_codim2_P2_NL_unfold_full_2';
