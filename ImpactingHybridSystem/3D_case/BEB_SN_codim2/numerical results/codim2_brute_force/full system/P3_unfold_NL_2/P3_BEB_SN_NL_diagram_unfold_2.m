% clear
load('.\P3_NL_brute_force_diagram_2.mat')
...
%% post processing
name ='.\3D_BEB_SN_codim2_P3_NL_unfold_full_2';
...
plot(0.0225,0.09157,'rd','markersize',4,'markerfacecolor',[1 1 1],'linewidth',2);
plot(0.01431,0.05572,'rd','markersize',4,'markerfacecolor',[1 1 1],'linewidth',2);
plot(0.0098,0.0385,'rd','markersize',4,'markerfacecolor',[1 1 1],'linewidth',2);
