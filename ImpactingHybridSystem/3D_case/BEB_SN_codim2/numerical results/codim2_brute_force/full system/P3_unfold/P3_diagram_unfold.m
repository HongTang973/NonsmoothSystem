...
data(data<=1e-5) = NaN;
on_eq_id         = A_diagram(:,1)>-PD_U;
% Peter_CreatePlotInOrigin(beta_diagram,'beta_diagram')   
plot(A_diagram(on_eq_id,1)+PD_U,data(on_eq_id),'k.','markersize',12)
h0 = plot(0,0,'k.','linewidth',3,'markersize',12,'displayname','Stable LCO');
hold on
...
h4 = plot(PD_U,S_br(end),'rd','markersize',4,'markerfacecolor',[1 1 1],'linewidth',2,'DisplayName','SN point');
