...
h3=plot(T_chosen(1),F1_chosen(end),'bo','markersize',10,'markerfacecolor',...
    'blue','linewidth',2,'displayname',['the ',num2str(1),'st candidate']);
...
legend([h1 h3 ],'Location', 'best','interpreter','latex')
...
h2_1=plot3(yout(:,1)-1,yout(:,2),yout(:,3),'b-','linewidth',2,'displayname','Stable LCO');
hold on; grid on
h2_0 = plot3(pe(1)-1,pe(2),pe(3),'ro','linewidth',2,'markerfacecolor',[1 1 1],'displayname','Unstable PE');

% patch
box0_x = [0.034 0.049 0.049 0.034 0.034]*0;
box0_y = [-0.5 0.5 0.5 -0.5 -0.5 ];
box0_z = [-1.8 -1.8 -0.8 -0.8 -1.8 ]
...
legend([h2_0 h2_1  h2_3],'Location', 'best','interpreter','latex')
