...
% ------SubCASE 4: LAMBDA_3 = 1;  lambda_1 & lambda_2 are complex -------%
...
%     b3 = 0.2;
    ...
    try
        ...
        if ~isempty(T_chosen) && length(T_chosen)<3
...
save('Monte_3D_case4.mat','Monte_3D')
% error at-0.32+1i,-0.32-1i,0.12
% error at-0.36+1i,-0.36-1i,0.28
% error at-0.4+1i,-0.4-1i,0.44
% error at-0.48+1i,-0.48-1i,0.76
% error at-0.44+1i,-0.44-1i,0.6
% error at-0.48+0.92i,-0.48-0.92i,0.72
% error at-0.44+0.92i,-0.44-0.92i,0.56
% error at-0.52+1i,-0.52-1i,0.92
% error at-0.56+0.88i,-0.56-0.88i,1
