...
clear
close all
% par = [-0.0109332136347728;0.00730000000000000;-1;2.01707011290029;1;0.100000000000000];

par = [-0.00348950817196607;0.0073;-1;2.01676234895698;1;0.10];
lambda_1 = par(1);
...
SDS_IHS_Int(A,R,C,sign(C*A*LCO)*InitCond,[0 1],fs,sign(C*A*LCO),tol);
