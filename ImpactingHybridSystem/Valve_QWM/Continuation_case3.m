...
par = [343.14, 0.78, 0.05 , 1.058,  100]';
keys = {'a', 'rx', 'kappa','L', 'RT'};
% record the index 
...
[u2,iter2] = codim1_PC(@ZeroFunctions_Valve_QWM_HB,par,ind_p,ind_x,p_span,x_span,-1);
CPU_tim = toc
